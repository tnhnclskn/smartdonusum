...
class UserQueryResponse
{
    ...
    /**
     * @var array<int<0,max>, \SmartDonusum\Type\ResponseUser>
     */
    private array $users;
    ...
    /**
     * @return array<int<0,max>, \SmartDonusum\Type\ResponseUser>
     */
    ...
    /**
     * @param array<int<0,max>, \SmartDonusum\Type\ResponseUser> $users
     * @return static
     */
