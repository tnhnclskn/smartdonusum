...
class ResponseDocument
{
    ...
    /**
     * @var array<int<0,max>, \SmartDonusum\Type\DocumentInfo>
     */
    private array $despatchInfo;

    /**
     * @var null | \SmartDonusum\Type\DocumentInfo
     */
    private ?\SmartDonusum\Type\DocumentInfo $orderInfo = null;

    /**
     * @var array<int<0,max>, \SmartDonusum\Type\TaxInfo>
     */
    ...
    /**
     * @return array<int<0,max>, \SmartDonusum\Type\DocumentInfo>
     */
    ...
    /**
     * @param array<int<0,max>, \SmartDonusum\Type\DocumentInfo> $despatchInfo
     * @return static
     */
    ...
    /**
     * @return null | \SmartDonusum\Type\DocumentInfo
     */
    public function getOrderInfo(): ?\SmartDonusum\Type\DocumentInfo
    {
        return $this->orderInfo;
    }

    /**
     * @param null | \SmartDonusum\Type\DocumentInfo $orderInfo
     * @return static
     */
    public function withOrderInfo(?\SmartDonusum\Type\DocumentInfo $orderInfo): static
    {
        $new = clone $this;
    ...
    /**
     * @return array<int<0,max>, \SmartDonusum\Type\TaxInfo>
     */
    ...
    /**
     * @param array<int<0,max>, \SmartDonusum\Type\TaxInfo> $taxInfo
     * @return static
     */
