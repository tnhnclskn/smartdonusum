...
class DocumentQueryResponse
{
    ...
    /**
     * @var array<int<0,max>, \SmartDonusum\Type\ResponseDocument>
     */
    ...
    /**
     * @return array<int<0,max>, \SmartDonusum\Type\ResponseDocument>
     */
    ...
    /**
     * @param array<int<0,max>, \SmartDonusum\Type\ResponseDocument> $documents
     * @return static
     */
