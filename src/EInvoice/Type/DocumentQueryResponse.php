...
class DocumentQueryResponse
{
    ...
    /**
     * @var array<int<0,max>, \SmartDonusum\EInvoice\Type\ResponseDocument>
     */
    ...
    /**
     * @return array<int<0,max>, \SmartDonusum\EInvoice\Type\ResponseDocument>
     */
    ...
    /**
     * @param array<int<0,max>, \SmartDonusum\EInvoice\Type\ResponseDocument> $documents
     * @return static
     */
