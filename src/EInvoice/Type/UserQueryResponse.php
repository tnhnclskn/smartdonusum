...
class UserQueryResponse
{
    ...
    /**
     * @var array<int<0,max>, \SmartDonusum\EInvoice\Type\ResponseUser>
     */
    private array $users;
    ...
    /**
     * @return array<int<0,max>, \SmartDonusum\EInvoice\Type\ResponseUser>
     */
    ...
    /**
     * @param array<int<0,max>, \SmartDonusum\EInvoice\Type\ResponseUser> $users
     * @return static
     */
