...
class SendApplicationResponse implements RequestInterface
{
    /**
     * @var array<int<0,max>, \SmartDonusum\EInvoice\Type\InputDocument>
     */
     ...
     * Constructor
     *
     * @param array<int<0,max>, \SmartDonusum\EInvoice\Type\InputDocument> $inputDocumentList
     */
    ...
    /**
     * @return array<int<0,max>, \SmartDonusum\EInvoice\Type\InputDocument>
     */
