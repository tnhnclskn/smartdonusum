...
class ResponseDocument
{
    ...
    /**
     * @var array<int<0,max>, \SmartDonusum\EInvoice\Type\DocumentInfo>
     */
    private array $despatchInfo;

    /**
     * @var null | \SmartDonusum\EInvoice\Type\DocumentInfo
     */
    private ?\SmartDonusum\EInvoice\Type\DocumentInfo $orderInfo = null;

    /**
     * @var array<int<0,max>, \SmartDonusum\EInvoice\Type\TaxInfo>
     */
    ...
    /**
     * @return array<int<0,max>, \SmartDonusum\EInvoice\Type\DocumentInfo>
     */
    ...
    /**
     * @param array<int<0,max>, \SmartDonusum\EInvoice\Type\DocumentInfo> $despatchInfo
     * @return static
     */
    ...
    /**
     * @return null | \SmartDonusum\EInvoice\Type\DocumentInfo
     */
    public function getOrderInfo(): ?\SmartDonusum\EInvoice\Type\DocumentInfo
    {
        return $this->orderInfo;
    }

    /**
     * @param null | \SmartDonusum\EInvoice\Type\DocumentInfo $orderInfo
     * @return static
     */
    public function withOrderInfo(?\SmartDonusum\EInvoice\Type\DocumentInfo $orderInfo): static
    {
        $new = clone $this;
    ...
    /**
     * @return array<int<0,max>, \SmartDonusum\EInvoice\Type\TaxInfo>
     */
    ...
    /**
     * @param array<int<0,max>, \SmartDonusum\EInvoice\Type\TaxInfo> $taxInfo
     * @return static
     */
